...
const Navbar = () => {
  return (
    <div className='flex justify-between items-center w-full max-w-7xl bg-violet-100/[0.8] dark:bg-slate-800/[0.8] p-3 md:p-4 gap-4 fixed top-0 left-0 right-0 z-10 shadow-lg shadow-violet-500/[0.3] mx-auto dark:shadow-violet-400/[0.4] '>
