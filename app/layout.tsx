...
export default function RootLayout({
  ...
  return (
    <html lang='en' suppressHydrationWarning>
      ...
      <body
        className={`flex flex-col max-w-7xl min-h-screen mx-auto bg-violet-50 text-violet-900 dark:bg-slate-900 dark:text-violet-200 ${geistSans.variable} ${geistMono.variable} antialiased`}>
        <ThemeProvider
          attribute='class'
          defaultTheme='dark'
          enableSystem
